...
public class DesUtil {
	/*
	 */
	public static String strDefaultKey = "12345678";
	...
	/**
	 * @param strDefaultKey the strDefaultKey to set
	 */
	public static void setStrDefaultKey(String strDefaultKey) {
		DesUtil.strDefaultKey = strDefaultKey;
	}
	...
	public static String Decode(String str) {
		...
		i2 = DesUtil.DECRYPT(DesUtil.strDefaultKey.getBytes(), byteMingW, byteMiW,
				byteMiW.length);
