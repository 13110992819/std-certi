...
public class SendAuthReqUtil {
    static Logger logger = Logger.getLogger(SendAuthReqUtil.class);
    ...
    public static void setStrDefaultKey(String strDefaultKey) {
        SendAuthReqUtil.strDefaultKey = strDefaultKey;
    }
     ...
     */
    private static void desMemcpy(byte[] output, byte[] input, int outpos,
            int inpos, int len) {
        int i;
        for (i = 0; i < len; i++)
    ...
    public static String sendHttpRequest(String url,
            Map<String, String> cloneParamMap) throws Exception {
        ...
        httpclient.getParams().setIntParameter(HttpConnectionParams.SO_LINGER,
            30);
    ...
    public static List<NameValuePair> getNameValuePairArr(
    ...
    public static void main(String[] args) {
        ...
        String md5Str = "userId" + userId + "auName" + name + "auId" + idCode
                + "ts" + ts + mKey;
        ...
        try {
            logger.debug(urlStr + "?userId=" + userId + "&coopOrderNo=&auName="
                    ...
                    + "&ts=" + ts + "&sign=" + md5Str);
            logger.debug(sendHttpRequest(urlStr, params));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
