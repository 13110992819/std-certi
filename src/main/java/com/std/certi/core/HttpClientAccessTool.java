...
public class HttpClientAccessTool {

    private static HttpClientAccessTool smsClientToolInstance;

    /**
     * 采用单列方式来访问操作
     * @return
     */
    public static synchronized HttpClientAccessTool getInstance() {

        if (smsClientToolInstance == null) {
            smsClientToolInstance = new HttpClientAccessTool();
        }
     ...
     * @return
     */
    public static String doAccessHTTPPost(String sendUrl, String sendParam,
